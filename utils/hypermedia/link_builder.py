...
def build_standard_links(entity_type, entity_id=None, extra_links=None):
    ...
    if entity_id:
        if entity_type == "task":
            ...
            links["update"] = {
                "href": url_for(
                    "project_routes.update_project", project_id=entity_id, _external=True
                ),
                "method": "PUT",
            ...
            links["delete"] = {
                "href": url_for(
                    "project_routes.delete_project", project_id=entity_id, _external=True
                ),
                "method": "DELETE",
            ...
            links["tasks"] = {
                "href": url_for(
                    "project_routes.get_project_tasks", project_id=entity_id, _external=True
                ),
                "method": "GET",
...
def build_project_links(project_id=None):
    ...
    links["collection"] = {
        "href": safe_url("project_routes.get_all_projects"),
        "method": "GET",
        "title": "All projects",
    }
    links["create"] = {
        "href": safe_url("project_routes.create_project"),
        "method": "POST",
        "title": "Create new project",
    }

    if project_id:
        for op, method, title in [
            ("get_project", "GET", "View this project"),
...
def add_project_hypermedia_links(project_dict):
    ...
    links = {
        "self": {
            "href": safe_url("project_routes.get_project", project_id=project_id),
            "method": "GET",
        },
        "collection": {"href": safe_url("project_routes.get_all_projects"), "method": "GET"},
        "update": {
            "href": safe_url("project_routes.update_project", project_id=project_id),
            "method": "PUT",
        },
        "delete": {
            "href": safe_url("project_routes.delete_project", project_id=project_id),
            "method": "DELETE",
        },
        "tasks": {
            "href": safe_url("task_routes.get_tasks", project_id=project_id),
            "method": "GET",
    ...
    if team_id:
        links["team"] = {
            "href": safe_url("team_routes.get_team", team_id=team_id),
            "method": "GET",
    ...
    if owner_id:
        href = safe_url("user_routes.get_user", user_id=owner_id) or safe_url(
            "user_routes.fetch_user", user_id=owner_id
        )
        if href:
