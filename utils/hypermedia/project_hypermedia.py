...
def build_project_links(project):
    ...
    links = {
        ...
        "self": {"href": f"/projects/{project_id}", "method": "GET", "title": "View this project"},
        # Update operation
        "update": {
        ...
        # Projects collection
        "collection": {"href": "/projects", "method": "GET", "title": "All projects"},
        # Create new project
        "create": {"href": "/projects", "method": "POST", "title": "Create a new project"},
        # API root
        "root": {"href": "/", "method": "GET", "title": "API root"},
    }
...
def build_project_collection_links():
    ...
    """
    return {
        "self": {"href": "/projects", "method": "GET", "title": "All projects"},
        "create": {"href": "/projects", "method": "POST", "title": "Create a new project"},
        "root": {"href": "/", "method": "GET", "title": "API root"},
        "tasks": {"href": "/tasks", "method": "GET", "title": "All tasks"},
        "teams": {"href": "/teams", "method": "GET", "title": "All teams"},
        "users": {"href": "/users", "method": "GET", "title": "All users"},
    }
